...
public class SlideScreen {
	...
	public SlideScreen(AppiumDriver driver) {
	...
	*/
	...
	public static void slideUp(AppiumDriver driver) {
	...
	new TouchAction(driver).press(PointOption.point(width / 2, 200)).waitAction(WaitOptions.waitOptions(duration)).
