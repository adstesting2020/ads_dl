...
//		saveReportInfo("即契約確認・エリア判定・申込みメニュー画面", "btn1_2Click.jpg");
		
		hpObj.btn2_1Click("btn2_1Click.jpg");
//		saveReportInfo("即契約確認・エリア判定・申込みメニュー画面", "btn2_1Click.jpg");
		
		hpObj.btn3_1Click("btn3_1Click.jpg");
		saveReportInfo("即契約確認・エリア判定・申込みメニュー画面", "btn3_1Click.jpg");
		...
		saveReportInfo("即契約確認・エリア判定・申込みメニュー画面", "input4.jpg");
		
		hpObj.clickNITTEI("Nittei.jpg");
		saveReportInfo("即契約確認・エリア判定・申込みメニュー画面", "Nittei.jpg");
		// 
